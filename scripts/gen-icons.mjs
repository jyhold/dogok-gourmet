...
const ICONS = {
  ...
  kalguksu: bowl('T', [[4, 7, 'L'], [6, 8, 'W'], [9, 7, 'L'], [11, 8, 'r']]), // 칼국수 (애호박·홍고추, 김 오름)
  // 냉면·갈비탕 — 찬 육수(하늘색) + 삶은계란/오이/편육. steam=false로 '차갑다'를 표현해 칼국수와 구분.
  naengmyeon: bowl('S', [[4, 7, 'W'], [5, 8, 'W'], [8, 7, 'L'], [10, 7, 'M'], [11, 8, 'M']], false),
  ...
  // ── 개별 도트 (고유 실루엣) ──
  shabu: [ // 샤브샤브 (양손잡이 전골냄비 + 채소/고기 + 김) — 그릇 계열과 구분되게 냄비 실루엣
    '................',
    '................',
    '.....A..A.A.....',
    '.....A..A.A.....',
  ...
  taco: [ // 멕시칸·타코 (U자 또띠아 껍질 + 속재료: 상추·토마토·치즈·고기)
    '................',
    '................',
    '................',
    '....L..R..G.....',
  ...
  dimsum: [ // 홍콩·딤섬 (대나무 찜기 2단 스택 + 김) — 만두(찜기 위 만두 2개)와 구분
    '................',
    '......AA........',
    '.....A..A.......',
    '................',
